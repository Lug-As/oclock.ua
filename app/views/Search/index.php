    ...
    <div class="container">
        <div class="breadcrumbs-main">
            <ol class="breadcrumb">
                ...
                <li class="">Поиск по запросу "<strong><?= safeHtmlChars($query); ?></strong>"</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="prdt-top">
            <div class="col-md-9 prdt-left">
                   ...
                   <div class="product-one">
                       <h4>Найдено товаров: <?= count($products); ?></h4>
                          ...
                          <div class="col-md-4 product-left p-left">
                              <div class="product-main simpleCart_shelfItem">
                                  ...
                                  <div class="product-bottom">
                                      <h3><a href="product/<?= $product->alias; ?>"
                                             class="mask"><?= \app\controllers\SearchController::getMatchedString($product->title, $query); ?></a>
                                      </h3>
                                      <p>Explore Now</p>
                                      <h4>
                                          <a data-id="<?= $product->id; ?>" class="add-to-cart-link"
                                             href="cart/add?id=<?= $product->id; ?>"><i></i></a>
                                          <span class="item_price"><?= app\controllers\CurrencyController::getPriceString($product->price); ?></span>
											...
											<?php if ($product->old_price): ?>
                                     <div class="srch">
                                         <span><?= 100 * (1 - round($product->price / $product->old_price, 3)); ?>%</span>
                                     </div>
											<?php endif; ?>
                              </div>
                          </div>
                       ...
                       <div class="text-center">
						...
						<?php endif; ?>
					<?php else: ?>
                   <h2 class="text-center text-secondary"><small>Нет результатов по запросу
                           "<strong><?= safeHtmlChars($query); ?></strong>"</small></h2>
					<?php endif; ?>
            </div>
